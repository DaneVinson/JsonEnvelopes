...
## Get started
Install the [`JsonEnvelopes` NuGet Package](https://www.nuget.org/packages/JsonEnvelopes/) (e.g. version 1.3.1 from CLI).

    dotnet add package JsonEnvelopes --version 1.3.1
